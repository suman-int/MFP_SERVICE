...
public class MFPCommonUserController extends MfpKPIControllerBase {
	//
	private static final Logger log = LoggerFactory.getLogger(MFPCommonUserController.class);
